...
export class HtmlTextParser {
    ...
    protected static _ins: HtmlTextParser;
    public static get ins(): HtmlTextParser {
        if (!this._ins) {
    ...
    private _escapeSpecialSymbol(str) {
    ...
    protected _attributeToObject(attribute) {
    ...
    private _processEventHandler(eventString) {
        var index = 0;
        var obj = {};
